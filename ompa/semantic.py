...
class SemanticIndex:
    ...
    def _dedupe_by_path(
        ...
        """Return the top-scoring unique-path results up to limit."""
        seen: set[str] = set()
    ...
    def _score_all_chunks(
        self, query: str, query_embedding, hybrid: bool
    ) -> list[SearchResult]:
        """Score every chunk in the index and return unsorted SearchResults."""
        results = []
    ...
    def search(
        ...
        try:
            ...
            scored = self._score_all_chunks(query, query_embedding, hybrid)
