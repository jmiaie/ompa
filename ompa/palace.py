...
class Palace:
    ...
    def create_wing(self, name: str, type: str = "project",
    ...
    def link_drawer(self, wing: str, room: str, file_path: str) -> None:
        ...
        self._data["wings"][wing].setdefault("rooms", {}).setdefault(room, {"drawers": [], "halls": {}})
    ...
    def add_hall(self, wing: str, room: str, hall_type: str,
                 content: str) -> None:
    ...
    def create_tunnel(self, wing_a: str, wing_b: str, room: str,
                      hall_a: str = "hall_events",
                      hall_b: str = "hall_facts") -> None:
    ...
    def find_tunnels(self, wing_a: str, wing_b: str) -> list[dict]:
        ...
        return [
            t for t in tunnels
            if (t.get("wing_a") == wing_a and t.get("wing_b") == wing_b) or
               (t.get("wing_a") == wing_b and t.get("wing_b") == wing_a)
        ]
        ...
        for tunnel in result["tunnels"]:
            ...
            if connected_room:
                result["connected"].append({
                    ...
                    "hall": tunnel["hall_b"] if tunnel["wing_a"] == wing else tunnel["hall_a"],
                })
        return result
