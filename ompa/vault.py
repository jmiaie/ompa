...
class Note:
    ...
    def _extract_wikilinks(text: str) -> list[str]:
        ...
        for link in raw:
            ...
            # Strip .md extension so the stem matches the filename index keys
...
class Vault:
    ...
    def _resolve_brain_note_path(self, name: str) -> Path:
        """
        Resolve a brain note name to a safe, boundary-checked path.
        Raises ValueError if the name contains traversal characters or escapes the folder.
        """
